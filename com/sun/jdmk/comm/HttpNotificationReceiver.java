/*
 * @(#)file      HttpNotificationReceiver.java
...
/**
 * This class implements the notification receiver of the HTTP/TCP connector.
...
class HttpNotificationReceiver extends GenericHttpNotificationReceiver {
    ...
    /**
     * Constructs an <CODE>HttpNotificationReceiver</CODE>.
     */
    public HttpNotificationReceiver(GenericHttpConnectorClient connector,
                                    ClientNotificationDispatcher dispatcher) {

        super(CommunicatorServer.HTTP_TYPE, 0, connector, dispatcher);
    }

    /**
     * Creates a socket to be used for a HTTP-based adaptor using TCP.
     * <P>
