/*
 * @(#)file      HttpsToPortSocketFactory.java
...
/**
 * HttpsToPortSocketFactory creates a socket connection to the
 * specified host that is communicated within an HTTPS request,
