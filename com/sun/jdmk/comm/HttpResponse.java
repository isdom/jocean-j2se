 ...
 *
 * readFrom() and writeTo() implements the parsing and
 * the formatting of an HTTP response.
 */
...
class HttpResponse extends HttpMessage {
    ...
    //
    // The HTTP error codes we use in JDMK
    //
    ...
    public void readFrom(InputStream s) 
        ...
        // REMIND: to be implemented when needed
    }
	...
	final String firstLine =
	    ...
	    statusCode + " " +
	    ((reasonPhrase == null) ? "NoPhrase" : reasonPhrase);
