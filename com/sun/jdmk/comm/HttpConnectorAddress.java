/*
 * @(#)file      HttpConnectorAddress.java
 ...
 * HTTP connector in order to carry out login/password authentication.
 *
...
public class HttpConnectorAddress implements GenericHttpConnectorAddress {
     ...
     * <P>
     * The default port is defined by org.jocean.j2se.jdmk.ServiceName.HTTP_CONNECTOR_PORT.
     */
    public HttpConnectorAddress() {
        ...
        if (logger.finerOn())
            logger.finer("HttpConnectorAddress", "host="+host);
    ...
    /**
     * Clone this <CODE>HttpConnectorAddress</CODE>.
