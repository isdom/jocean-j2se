/*
 * @(#)file      GenericHttpSocketFactory.java
...
abstract class GenericHttpSocketFactory {
     ...
     */
    public abstract Socket createSocket(String host, int port, GenericHttpConnectorClient connector)
	throws IOException;
