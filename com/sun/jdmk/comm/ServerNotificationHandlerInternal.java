/*
 * @(#)file      ServerNotificationHandlerInternal.java
...
/**
 * This interface should be implemented by an agent connector in order to use jdmk event mechanism.
 */
interface ServerNotificationHandlerInternal {
	/**
