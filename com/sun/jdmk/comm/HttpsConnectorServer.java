 ...
 *
 * @see org.jocean.j2se.jdmk.comm.HttpsConnectorClient
 *
 */
public class HttpsConnectorServer
    ...
    public HttpsConnectorServer() {
        super(CommunicatorServer.HTTPS_TYPE,
	      org.jocean.j2se.jdmk.ServiceName.HTTPS_CONNECTOR_PORT);
    }
     ...
     * {@link org.jocean.j2se.jdmk.ServiceName#HTTPS_CONNECTOR_SERVER 
     *        org.jocean.j2se.jdmk.ServiceName.HTTPS_CONNECTOR_SERVER}.
	...
	throws Exception {
        if (name == null) {
            name = new ObjectName(org.jocean.j2se.jdmk.ServiceName.DOMAIN + ":" + 
			   org.jocean.j2se.jdmk.ServiceName.HTTPS_CONNECTOR_SERVER);
        }
