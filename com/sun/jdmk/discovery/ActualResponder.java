...
import org.jocean.j2se.jdmk.comm.RmiConnectorAddress ; 
import org.jocean.j2se.jdmk.comm.HttpConnectorAddress ; 
import org.jocean.j2se.jdmk.comm.HttpsConnectorAddress ; 
import org.jocean.j2se.jdmk.comm.AuthInfo ;
...
class ActualResponder extends DiscoveryCommon {
	...
	if (logger.finerOn()) {
        ...
        // Set Logging stuff
        // ------------------------
	localClassName = "org.jocean.j2se.jdmk.discovery.ActualResponder" ;
	...
	if ( rcvPDU.getHost() != null ) {
		...
		if (!org.jocean.j2se.jdmk.internal.Useful.isLocalHost(rcvPDU.getHost())) {
		    if (logger.finerOn()) {
	...
	if ( setAdp == true ) {
	    ...
	    // ------------------------
	    {
		String val = "org.jocean.j2se.jdmk.comm.RmiConnectorServer" ;
		try {
	    ...
	    // ------------------------
	    {
		String val = "org.jocean.j2se.jdmk.comm.HttpConnectorServer" ;
		try
		    {
			result = cmf.queryNames(name, Query.match(Query.classattr(),Query.value(val)));
	    ...
	    // ------------------------
	    {
		String val = "org.jocean.j2se.jdmk.comm.HttpsConnectorServer" ;
		try
		    {
			result = cmf.queryNames(name, Query.match(Query.classattr(),Query.value(val)));
	    ...
	    // ------------------------
	    {
		String val = "org.jocean.j2se.jdmk.comm.HtmlAdaptorServer" ;
		try {
		    result = cmf.queryNames(name, Query.match(Query.classattr(),Query.value(val)));
	    ...
	    // ------------------------
	    {
		String val = "org.jocean.j2se.jdmk.comm.SnmpAdaptorServer" ;
		try {
		    result = cmf.queryNames(name, Query.match(Query.classattr(),Query.value(val)));
