 ...
 * {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponder} objects on a given multicast group.
 ...
 * When a {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponder} is registered in an MBean server and when its start or stop methods
 ...
 * unregistration message, it sends a {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponderNotification}
 ...
 * unregistering messages from {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponder} objects.
...
public class DiscoveryMonitor extends NotificationBroadcasterSupport 
     ...
     * multicast socket used to listen for {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponder}
    ...
    // ----------------------------------------------------------
    /**
     * Starts listening for {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponder} objects registering/unregistering.
     * <P>
   ...
   /**
    ...
    // Logging stuff
    // ----------------------------------------------------------
    private String localClassName = "org.jocean.j2se.jdmk.discovery.DiscoveryMonitor" ;
