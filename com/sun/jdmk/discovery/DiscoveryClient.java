...
package org.jocean.j2se.jdmk.discovery;
...
import org.jocean.j2se.jdmk.* ;
import org.jocean.j2se.jdmk.comm.CommunicationException ;
import org.jocean.j2se.jdmk.internal.ClassLogger;


/**
 * Provides methods to discover Java DMK agents.
 * A Java DMK agent can only discovered if it has a 
 * {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponder} registered in its MBean server.
 * A discovery operation is executed in two steps:
 * <UL>
 *   <LI>a <CODE>DiscoveryClient</CODE> broadcasts a discovery request on a
 *       multicast group</LI>
 *   <LI>Registered {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponder} MBeans listening on the multicast group 
 *       catch the request. Each {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponder}
 *       sends a discovery response to the <CODE>DiscoveryClient</CODE></LI>
 * </UL>
 * <p>
 * A <CODE>DiscoveryClient</CODE> can only reach the 
 * {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponder} objects that listen on the same multicast group and 
 ...
 * and {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponder} objects.
 * <p>
 ...
 * {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponse}. A {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponse} is included
 * for each discovered Java DMK agent. It provides the host name and the MBean server information of the
 * agent ( see {@link javax.management.MBeanServerDelegate} and {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponse}) and optionally
 * the list of communicator (Adaptor and connector) available in the agent.
 * <p>
 * A {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponder} can send back responses using two modes:
 * <UL>
 *   <LI> Unicast mode. A datagram socket is sent from the {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponder}
 ...
 *   </LI>
 *   <LI> Multicast mode. A multicast socket is used between the {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponder}
 *        and the <CODE>DiscoveryClient</CODE>. The response is multicasted to the group. This 
 *        behavior allows {@link org.jocean.j2se.jdmk.discovery.DiscoveryMonitor} objects to be aware of changes.
...
public class DiscoveryClient implements java.io.Serializable, DiscoveryClientMBean, MBeanRegistration{
     ...
     * <P>
     * Returns a vector of {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponse}, one element for each discovered Java DMK agent.
     * Each {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponse} contains the host name and the MBean server information of the
     * discovered agent ( see {@link javax.management.MBeanServerDelegate} and {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponse}). 
     * The communicators list is not relevant: it is set to null.
     *
     * @return A vector of {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponse}.
     *
    ...
    /**
     * Discovers whether Java DMK agents with a {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponder}
     * registered in any MBean server is on a host.
     * <P>
     * Returns a vector of {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponse}, one element for each discovered Java DMK agent on the specified host.
     * Each {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponse} only contains the host name and the MBean server information of the 
     * discovered agent ( see {@link javax.management.MBeanServerDelegate} and {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponse}) of the specified host.
     * The communicators list is not relevant: it is set to null. 
     *
     ...
     * <P>  
     * Returns a vector of {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponse}, one element for each discovered Java DMK agent. 
     * Each {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponse} contains the host name, the MBean server information of the 
     * discovered agent ( see {@link javax.management.MBeanServerDelegate} and {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponse}) and
    ...
    // Logging stuff
    // ----------------------------------------------------------
    private String localClassName = "org.jocean.j2se.jdmk.discovery.DiscoveryClient" ;
