 ...
 * {@link org.jocean.j2se.jdmk.discovery.DiscoveryMonitor} MBean to its listener.
 * The <CODE>DiscoveryResponderNotification</CODE> object is sent by the 
 * {@link org.jocean.j2se.jdmk.discovery.DiscoveryMonitor} when it receives a 
 * registration or unregistration message from a {@link 
 * org.jocean.j2se.jdmk.discovery.DiscoveryResponder}.
 *
 *
 */
...
public class DiscoveryResponderNotification extends Notification {
     ...
     * <CODE>org.jocean.j2se.jdmk.discovery</CODE>.
     */
    public static final String REGISTRATION = "org.jocean.j2se.jdmk.discovery" ;
     ...
     *    {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponder} object has been
   ...
   * <P>
   * If the state is <CODE>DiscoveryMonitor.ONLINE</CODE>, a {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponder} object has been
   * added to an agent. 
   * If the state is <CODE>DiscoveryMonitor.OFFLINE</CODE>, a {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponder} object has been
   ...
   * also returns a list of communicators ( see {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponse} description).
   * <P>
   * If state is <CODE>DiscoveryMonitor.OFFLINE</CODE>, only the <CODE>host</CODE>
   * and MBeanServer information are significant in the {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponse} object.
   *
   * @return A {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponse} object. This object contains the hostname 
   *         as a string <CODE>host</CODE> and  MBeanServer information.
   *         It also contains a list of communicators ( see {@link org.jocean.j2se.jdmk.discovery.DiscoveryResponse} description)
