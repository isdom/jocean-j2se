...
/**
 * The <CODE>DiscoveryResponse</CODE> is used by the {@link org.jocean.j2se.jdmk.discovery.DiscoveryClient}
 * class to represent the result of a discovery operation.
 *
 * @see 	org.jocean.j2se.jdmk.discovery.DiscoveryClient
 */
...
// ----------------------------------------------------------
  ...
  /**
     ...
     * {@link org.jocean.j2se.jdmk.comm.ConnectorAddress} if its relevant.
