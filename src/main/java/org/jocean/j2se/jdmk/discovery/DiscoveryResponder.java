 ...
 * org.jocean.j2se.jdmk.discovery.DiscoveryMonitor} objects to
...
public class DiscoveryResponder 
   ...
   */
	...
	if (inf != null &&
	    !org.jocean.j2se.jdmk.internal.Useful.isLocalHost(inf)) {
	...
	if (local != null &&
	    !org.jocean.j2se.jdmk.internal.Useful.isLocalHost(local)) {
