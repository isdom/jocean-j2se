...
public class ClassLogger {
	...
	if (ok) {
	    ...
	    Logger.getLogger("org.jocean.j2se.jdmk").logp(java.util.logging.Level.FINE,
		   "ClassLogger",
		   "init",
                   "Java DMK build version [" +
                        org.jocean.j2se.jdmk.ServiceName.JMX_IMPL_VERSION +"]" +
    ...
    public final static String LOGGER_JDMK = "org.jocean.j2se.jdmk";
