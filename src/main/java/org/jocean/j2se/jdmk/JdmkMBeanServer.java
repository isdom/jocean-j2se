...
/**
 * Extends the MBeanServer interface to provide methods for
 * getting and setting the MBeanServerInterceptor to which all requests
 * are delegated.
 *
 * @since Java DMK 5.1
 */
public interface JdmkMBeanServer extends MBeanServer {
    /**
     * Return the MBeanServerInterceptor to which all requests from the
    ...
    /**
     * <p>Change the MBeanServerInterceptor object to which all requests
    ...
    /**
     * Return the MBeanServer that must be passed as parameter to
     * the {@link javax.management.MBeanRegistration} interface.
     */
