...
public interface JdmkLegacyConnector {
    ...
    /**
     * Specifies a list of AuthInfo (org.jocean.j2se.jdmk.comm.AuthInfo[]) for an
     * HTTP or HTTPS connector server.
     * <p>
     * The key value is the string "org.jocean.j2se.jdmk.http.server.authinfo.list".
     */
    public final static String HTTP_SERVER_AUTHINFO_LIST =
        "org.jocean.j2se.jdmk.http.server.authinfo.list";

    /**
     * Specifies the local InetAddress the HTTP/HTTPS connector server will
     * bind to.
     * <p>
     * The key value is the string "org.jocean.j2se.jdmk.http.server.local.address".
     */
    public final static String HTTP_SERVER_LOCAL_ADDRESS =
        "org.jocean.j2se.jdmk.http.server.local.address";
     ...
     * <p>
     * The key value is the string "org.jocean.j2se.jdmk.https.server.need.client.auth",
