...
class HttpSocketFactory extends GenericHttpSocketFactory {

    /**
     * Default factory to initially use for direct http to port socket connection.
     */
    protected GenericHttpSocketFactory factory = new HttpToPortSocketFactory();
