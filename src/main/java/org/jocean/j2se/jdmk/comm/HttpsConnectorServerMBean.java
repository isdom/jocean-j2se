/*
 * @(#)file      HttpsConnectorServerMBean.java
...
// @(#)HttpsConnectorServerMBean.java 1.7 07/03/08 
 ...
 */
public interface HttpsConnectorServerMBean 
     ...
     * {@link java.io.InterruptedIOException} is raised, though the Socket
