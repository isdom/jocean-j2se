/*
 * @(#)file      RmiConnectorServerObjectV2.java
...
interface RmiConnectorServerObjectV2 extends Remote {
    /**
     * ---------------------------------------------------------
     ...
     *            to instantiate set the attribute.
     */
     ...
     *            the setAttributes method of a Dynamic MBean.
     */
