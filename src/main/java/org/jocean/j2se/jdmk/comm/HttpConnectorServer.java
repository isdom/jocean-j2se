 ...
 *
 * @see org.jocean.j2se.jdmk.comm.HttpConnectorClient
 *
 */
public class HttpConnectorServer extends GenericHttpConnectorServer implements HttpConnectorServerMBean {
    ...
    public HttpConnectorServer() {
        super(CommunicatorServer.HTTP_TYPE, org.jocean.j2se.jdmk.ServiceName.HTTP_CONNECTOR_PORT);
    }
     ...
     * {@link org.jocean.j2se.jdmk.ServiceName#HTTP_CONNECTOR_SERVER org.jocean.j2se.jdmk.ServiceName.HTTP_CONNECTOR_SERVER}.
    ...
    public ObjectName preRegister(MBeanServer server, ObjectName name) throws Exception {
        if (name == null) {
            name = new ObjectName(server.getDefaultDomain() + ":" + org.jocean.j2se.jdmk.ServiceName.HTTP_CONNECTOR_SERVER);
        }
