/*
 * @(#)file      NotificationBackConnector.java
...
/**
 * This interface should be implemented by an agent connector to allow
 * the mode "push" to be used by jdmk event mechanism.
 */
interface NotificationBackConnector extends Remote {
	/**
