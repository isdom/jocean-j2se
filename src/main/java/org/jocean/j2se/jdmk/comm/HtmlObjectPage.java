...
import org.jocean.j2se.jdmk.Enumerated;
...
class HtmlObjectPage extends HtmlPage {
	...
	String safeObjNameStr = translateNameToHtmlFormat(objNameStr);
		...
		//
			...
			try {
			    ...
			    if ( (sc != null) && (org.jocean.j2se.jdmk.Enumerated.class.isAssignableFrom(sc)) ) {
    ...
    /** 
     * Returns the Html representation of an instance of org.jocean.j2se.jdmk.Enumerated,
	...
	boolean w = attrInfo.isWritable();
        ...
        // org.jocean.j2se.jdmk.Enumerated to representable HTML format.
        //
	try {
	    Class c ;
	    if (result != null) {
...
//             if (logger.finestOn()) {
// 		boolean t1 = (sc != null);
// 		boolean t2 = (Class.forName("org.jocean.j2se.jdmk.Enumerated").isAssignableFrom(sc));
