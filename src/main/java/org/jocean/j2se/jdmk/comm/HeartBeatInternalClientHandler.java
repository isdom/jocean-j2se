/*
 * @(#)file      HeartBeatInternalClientHandler.java
...
/**
 * Internal interface to be implemented by all the connector clients that want to support
 * the heartbeat mechanism.
 *
 */

interface HeartBeatInternalClientHandler {
