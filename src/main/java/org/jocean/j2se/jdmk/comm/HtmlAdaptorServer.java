 ...
 * <LI>using the {@link org.jocean.j2se.jdmk.comm.CommunicatorServer#setPort setPort} method before starting the adaptor
 * </UL>
 * The default object name is define by {@link org.jocean.j2se.jdmk.ServiceName#DOMAIN org.jocean.j2se.jdmk.ServiceName.DOMAIN} 
 * and {@link org.jocean.j2se.jdmk.ServiceName#HTML_ADAPTOR_SERVER org.jocean.j2se.jdmk.ServiceName.HTML_ADAPTOR_SERVER}.
 * <P>
 ...
 * <LI><CODE>org.jocean.j2se.jdmk.Enumerated</CODE>: Supported for readable attributes. As <CODE>org.jocean.j2se.jdmk.Enumerated</CODE> is an abstract class, 
...
public class HtmlAdaptorServer
     ...
     * <P>
     * The default port is defined in org.jocean.j2se.jdmk.ServiceName.HTML_ADAPTOR_PORT.
     */
    public HtmlAdaptorServer () {
        this(org.jocean.j2se.jdmk.ServiceName.HTML_ADAPTOR_PORT);
    }
     ...
     * {@link org.jocean.j2se.jdmk.comm.HtmlParser HtmlParser} and must already
	...
	boolean isParser = 
	    topMBS.isInstanceOf(parser,
				org.jocean.j2se.jdmk.comm.HtmlParser.class.getName());
	if (!isParser)
    ...
    public void createParser(String className, String parserName, 
        ...
        // Validate the parser.
        //
	if (!org.jocean.j2se.jdmk.comm.HtmlParser.class.isAssignableFrom(theParser.getClass())) {
	    theParser = null;
    ...
    public ObjectName preRegister(MBeanServer server, ObjectName name) 
        ...
        if (name == null) {
            name = new ObjectName(server.getDefaultDomain() +":"+ org.jocean.j2se.jdmk.ServiceName.HTML_ADAPTOR_SERVER);
        }
     ...
     * <P>
     * For a list of possible attributes look at the method {@link org.jocean.j2se.jdmk.comm.HtmlAdaptorServer#getAttribute getAttribute}.
     * 
     ...
     * <P>
     * For a list of possible attributes look at the method {@link org.jocean.j2se.jdmk.comm.HtmlAdaptorServer#setAttribute setAttribute}.
     *
	...
	for (int i = 0; i < ctor.length; i++) {
		...
		dconstructors[0] = new MBeanConstructorInfo("Instantiate HtmlAdaptorServer with default port number equal to " + org.jocean.j2se.jdmk.ServiceName.HTML_ADAPTOR_PORT + ".",ctor[i]);
