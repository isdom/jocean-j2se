 ...
 * @see org.jocean.j2se.jdmk.tasks.TaskServer
 *
 * @since Java DMK 5.0
 **/
...
public class DaemonTaskServer  implements TaskServer {
     ...
     * {@link org.jocean.j2se.jdmk.tasks.Task#run() task.run()}. It is provided
     ...
     * This method simply calls 
     * {@link org.jocean.j2se.jdmk.tasks.Task#cancel() task.cancel()}. 
     ...
     * to {@link #submitTask(org.jocean.j2se.jdmk.tasks.Task) submitTask()}.
     * When terminated, the object can not be started again, unless
     * {@link org.jocean.j2se.jdmk.tasks.DaemonTaskServer#reset()} is called.
     * @exception InterruptedException if cancel is interrupted.
     **/
     ...
     * {@link org.jocean.j2se.jdmk.tasks.DaemonTaskServer#terminate()}
