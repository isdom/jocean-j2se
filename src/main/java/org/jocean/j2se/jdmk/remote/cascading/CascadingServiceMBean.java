...
package org.jocean.j2se.jdmk.remote.cascading;
 ...
 * ObjectName("org.jocean.j2se.jdmk:type=CascadingService")</tt>.
 * </p>
 * <p>
 ...
 *     "org.jocean.j2se.jdmk.remote.cascading.failed"}</tt></li>
 ...
 * <ul>
 * <li>The <var>type</var> is <tt>{@link #CASCADING_FAILED_NOTIFICATION 
 *     "org.jocean.j2se.jdmk.remote.cascading.stopped"}</tt></li>
 * <li>The <var>source</var> is the <tt>CascadingServiceMBean</tt>.</tt></li>
 * <li>The <var>connectionId</var> is the <var>mountPointID</var> 
 *     that was returned by the the {@link #mount mount} method</li>
 * </ul>
 ...
 *    org.jocean.j2se.jdmk.remote.cascading#The_File_System_Analogy 
 *    org.jocean.j2se.jdmk.remote.cascading} package documentation, section 
...
public interface CascadingServiceMBean {
     ...
     *    new ObjectName("org.jocean.j2se.jdmk:type=CascadingService");
     * </pre>
     **/
	...
	new Object() {
		public final ObjectName getDefaultName() {
		    try {
			return new 
			    ObjectName("org.jocean.j2se.jdmk:type=CascadingService");
	...
	"org.jocean.j2se.jdmk.remote.cascading.failed";
	...
	"org.jocean.j2se.jdmk.remote.cascading.stopped";
